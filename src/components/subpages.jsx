    ...
    <React.Fragment>
      ...
      <section className="block"><div className="contact-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          <div className="card"><div className="ic"><Icon name="phone" size={22} /></div><div><h3>{P.cards.phoneTitle}</h3><p><a href={SITE.contact.phoneHref} style={{ color: 'var(--pum-navy)', fontWeight: 700 }}>{SITE.contact.phone}</a></p></div></div>
          <div className="card"><div className="ic" style={{ borderColor: '#2E9E5B', color: '#2E9E5B' }}><Icon name="message-circle" size={22} /></div><div><h3>{P.cards.whatsappTitle}</h3><p><a href={SITE.contact.whatsappHref} target="_blank" rel="noopener" style={{ color: '#2E9E5B', fontWeight: 800 }}>{P.cards.whatsappCta} →</a><br /><span style={{ color: 'var(--fg-mute)', fontSize: 13 }}>{SITE.contact.whatsapp}</span></p></div></div>
